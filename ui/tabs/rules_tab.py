...
class RulesTab(QWidget):
    ...
    def init_ui(self):
        ...
        # Query Input
        query_label = QLabel("Regulă Selecție (Fișierele care nu se potrivesc se duc în Carantină):")
        ...
        right_layout.addWidget(QLabel("Format Nume Fișier (Click pe butoane ca să inserezi!):"))
        ...
        variables = ["[An]", "[Luna]", "[TipDocument]", "[Emitent]", "[SubiectAI]", "_", "-"]
        row, col = 0, 0
    ...
    def on_save_clicked(self):
        ...
        if rules_db.save_rule(name, query, "", naming):
            ...
            QMessageBox.critical(self, "Eroare", "Nu am putut salva presetul în baza de date.")
